_base_ = [
    "../dino_detr/dino_detr_ssod_r50_coco_full_240k.py",
]
img_norm_cfg = dict(
...
#load_from = "/netscratch/shehzadi/cvpr/Baseline/trainings/zsupp/our2-WT2/work_dirs/detr_ssod_dino_detr_r50_coco_full_240k/iter_120000.pth"
...
lr_config = dict(step=[20000, 60000])
runner = dict(_delete_=True, type="IterBasedRunner", max_iters=80000)
checkpoint_config = dict(by_epoch=False, interval=4000, max_keep_ckpts=100, create_symlink=False)

_base_ = [
    "../dino_detr/dino_detr_ssod_r50_voc_80k.py",
]
img_norm_cfg = dict(
...
checkpoint_config = dict(by_epoch=False, interval=1000, max_keep_ckpts=200, create_symlink=False)


load_from = "/netscratch/shehzadi/MICCAI25/our2-semi/work_dirs_coco/4gpus/detr_ssod_dino_detr_r50_coco/10/1/iter_120000.pth"
